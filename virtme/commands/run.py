...
def console_server(args, qemu, arch, qemuargs, kernelargs, virtiofs_state):
    console_script_path = get_console_path(args.port)
...
def do_it() -> int:
    ...
    if args.force_9p:
        ...
        virtiofs_config = VirtioFSConfig(
            ...
            mount_tag="ROOTFS",
            rw=args.rw,
            # Older guest kernels can fail to boot external rootfs exports
            # when virtiofsd is started with --posix-acl.
            posix_acl=False,
        )
